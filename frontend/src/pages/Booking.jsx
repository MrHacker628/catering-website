                ...
                <div className="bk-trust__contact">
                  <div className="bk-trust__contact-row">
                    ...
                    <div>
                      ...
                      <a href="tel:+919699791068" className="bk-trust__contact-val">+91 96997 91068</a>
                    </div>
                  </div>
                  <div className="bk-trust__contact-row">
                    <span className="bk-trust__contact-icon">📧</span>
                    <div>
                      ...
                      <a href="mailto:info@mannatcaterers.com" className="bk-trust__contact-val">mannatcaterersgoa@gmail.com</a>
                    </div>
                  </div>
                  <div className="bk-trust__contact-row">
                    <span className="bk-trust__contact-icon">📍</span>
